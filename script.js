document.addEventListener('DOMContentLoaded', () => {
    ...
    function buildPortfolio(projects) {
        ...
        projects.forEach(project => {
            ...
            projectBox.innerHTML = `
                <img src="${project.folder}/${project.header}" alt="${project.name}">
    ...
    function openModal(project) {
        ...
        modalHTML += `<p class="project-description">${project.description}</p>`;
        
        project.files.forEach(file => {
            const filePath = `${project.folder}/${file}`;
            ...
            if (['mp4', 'webm', 'ogg'].includes(fileExtension)) {
                ...
                modalHTML += `<img src="${filePath}" alt="${file}">`;
            }
        });
